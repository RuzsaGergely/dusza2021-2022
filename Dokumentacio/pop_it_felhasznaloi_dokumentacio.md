...
<figure align="center">
    <img width="300" src="illusztraciok/felhasznaloi/menu.png">
...
<figure align="center">
    <img width="350" src="illusztraciok/felhasznaloi/palyavalaszto_menu.png">
...
<figure align="center">
    <img width="350" src="illusztraciok/felhasznaloi/jatek.png">
...
<figure align="center">
    <img width="300" src="illusztraciok/felhasznaloi/ervenytelen_lepes.png">
...
<figure align="center">
    <img width="300" src="illusztraciok/felhasznaloi/jatek_vege_nyert.png">
    <figcaption align="center"><sup>5. ábra - A nyertest bejelentő üzenet</sup></figcaption>
</figure>

<figure align="center">
    <img width="300" src="illusztraciok/felhasznaloi/jatek_vege_statisztika.png">
...
### 2. Pop-it! hub
A Pop-it! hub egy olyan rendszer ami elősegíti, hogy a játékosok a jobbnál-jobb pályáikat (vagy térképeiket ahogy mi szeretjük nevezni őket) megoszthassák mással, így többen ki tudják próbálni azokat. 

A Pop-it! hub-nak két fontos része van. Az egyik maga a kliens, ami képes a térképeket letölteni, valamint a weboldalunk ami ezeket a tartalmakat kiszolgálja, valamint lehetőséget nyújt arra, hogy le is töltsük azokat. Az alábbiakban azt láthatja, hogyan lehet le- illetve feltölteni térképeket.

### 2.1. Letöltés a Pop-it! hub-ról
Ahhoz, hogy a hub-ról le tudjunk tölteni térképeket az 1. ábrán már latható menüben nyomjunk rá a *Pop-it! - Hub* gombra. Ekkor az alábbi ablak jelenik meg.

<figure align="center">
    <img width="300" src="illusztraciok/felhasznaloi/hub_menu.png">
    <figcaption align="center"><sup>7. ábra - A Pop-it! hub (kliens oldalon)</sup></figcaption>
</figure>

Az ábrán szereplő lista nem reprezentatív. A térképek nevei mindig annak a függvényében alakulnak, hogy éppen mi van feltöltve az "elosztóra".
...
Ahhoz, hogy a hub-ra fel tudjunk tölteni térképet, ahhoz a 7. ábrán látható ablakban nyomjunk rá a *Feltöltés* gombra. Ez meg fogja nyitni az operációs rendszerünkben alapértelmezetten beállított böngészőt, benne pedig a Pop-it! hub oldalát.
...
A fájl feltöltő részen válassza ki a térkép állományát, majd kattintson a *feltöltés* gombra! Amennyiben nem ad meg állományt, úgy az oldal erre figyelmezteti.

A feltöltött állomány először egy ellenőrzésen megy át, ami megvizsgálja, hogy minden formai követelményt kielégít-e a térkép. Amennyiben minden rendben van, úgy ilyen üzenet fogad minket:
...
### 2.2.1. A térképek formai követelményei
A sikeres térkép feltöltéshez néhány elengedhetetlen követelménynek teljesülnie kell. A követelmények a következők:
- A térkép állománynak **.txt** kiterjesztésünek kell lennie!
